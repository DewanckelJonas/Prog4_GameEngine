...
void DigDugLevelEditScene::Initialize()
{
	...
	auto levelComp = std::make_shared<DigDugLevelComponent>("../Data/LevelEdit.gr", 400.f, 400.f);
...
void DigDugLevelEditScene::Update(float deltaTime)
{
	...
	{
		m_Level->GetComponent<DigDugLevelComponent>().lock()->Save("../Data/LevelEdit.gr");
	}
